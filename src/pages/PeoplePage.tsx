...
interface Person {
  ...
  name: string;
  title: string;
  category: 'faculty' | 'postdoc' | 'phd' | 'masters' | 'undergrad';
  bio: string;
  image: string;
  email?: string;
  website?: string;
...
const PeoplePage: React.FC = () => {
  const people: Person[] = [
    ...
    },
    {
      ...
      image: "https://images.pexels.com/photos/5684734/pexels-photo-5684734.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    ...
    },
    {
      ...
      category: "postdoc",
      bio: "Dr. Zhang works on machine learning approaches to code generation from natural language specifications and documentation generation.",
      image: "https://images.pexels.com/photos/5325840/pexels-photo-5325840.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      email: "lin.zhang@example.edu",
      github: "linzhang"
    },
    {
      id: 5,
      ...
      title: "PhD Candidate",
      category: "phd",
      bio: "Michael's dissertation research explores semantic analysis of code-switched documentation and comments in large open-source repositories.",
    ...
    },
    {
      ...
      title: "PhD Student",
      category: "phd",
      bio: "Sofia is developing intelligent code completion systems that understand natural language context from comments and documentation.",
      image: "https://images.pexels.com/photos/3765114/pexels-photo-3765114.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      email: "sofia.garcia@example.edu",
      github: "sgarcia"
    },
    {
      id: 7,
      ...
      category: "masters",
      bio: "David is working on IDE plugins that enhance developer productivity through natural language processing of code and comments.",
    ...
    },
    {
      ...
      title: "Masters Student",
      category: "masters",
      bio: "Elena is researching techniques for translating between programming languages using natural language as an intermediate representation.",
      image: "https://images.pexels.com/photos/3756679/pexels-photo-3756679.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      email: "elena.volkov@example.edu"
    }
  ];
      ...
      <Container className="py-12">
            ...
            <Section key={category.id} title={category.label} className="mb-12">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {categoryPeople.map((person) => (
                  <div key={person.id} className="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:shadow-lg hover:-translate-y-1 duration-300">
                    ...
                    <div className="p-6">
                      <h3 className="text-xl font-bold text-sjsu-navy">{person.name}</h3>
                      <p className="text-sjsu-blue font-medium mb-3">{person.title}</p>
        ...
        <Section title="Join Our Lab">
          <div className="max-w-3xl mx-auto text-center bg-sjsu-lightgray p-8 rounded-lg">
            <h3 className="text-xl font-bold text-sjsu-navy mb-4">Interested in Working With Us?</h3>
            <p className="text-gray-600 mb-6">
              We are always looking for motivated students and researchers interested in bilingual programming, 
              natural language processing, and human-computer interaction. If you are interested in joining our lab, 
              please contact the lab director with your CV and a brief statement of research interests.
            </p>
            <a 
